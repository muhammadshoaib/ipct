...
<head>
    ...
    <title>CTRP -- A Graphical Interface to view Resouces in CTRP Database</title>
...
<body id="page-top" class="index">
    ...
    <nav id="navbar-homepage" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand page-scroll" href="index.jsp">CTRP Edge</a>
            </div>
			...
			<a  data-toggle="collapse" 
 			...
 			<a id="btnViewTable" href="#" target="_blank">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a  id="aboutcMapper" href="#">About CTRP-Edge</a>
                    </li>
					  <li>
    ...
    <section id="aboutcMapperModel"  class="modal "  role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4>About CTRP-Edge</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;" id="cytoscapenote">
			<p class="lead">CTRP edge allows biologists to interrogate connection 
			between CTRP drugs and CCLE celllines in multiple biological contexts. 
			Input to CTRP-Edge consists of a set of celllines, small 
			molecules or genes, and the output is the data points in 
			CTRP, Expression Atlas and REACTOME connected with the given
			  celllines, small molecules or genes in the user's query. CTRP-Edge provides 
			  output to users in the form of a graph in which nodes 
			  represent data points and the edges represent connections 
			  between data points and inputted sets of celllines small 
			  molecules or genes. Furthermore,
			  Users can also apply filters based on database, drug sensitivity, 
			  mutation frequency and pathways 
    ...
    <!-- Modal -->
	<section class="modal" id="SupplementryInformationModel" 
	tabindex="-1" role="dialog">
	    <div class="modal-dialog supInformationModel">
    ...
    <section id="viewAtlasExpressionModel"  class="modal "  role="dialog">
    	<div class="modal-dialog informationModel">
	...
	<div id="lagents-filter-panel"style="display: none" class="popover">
		<div style="background: #31B5D6" class="lagentsItem">Cell Lines</div>
		<div style="background: #C6EFF7" class="lagentsItem">Associated Genes</div>
		<div style="background: #D63194" class="lagentsItem">Organisms</div>
    ...
    <footer class="navbar-fixed-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Shoaib et.al. 2017</span>
                </div>
                <div class="col-md-4">
